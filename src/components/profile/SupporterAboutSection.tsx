...
type SupporterAboutSectionProps = {
...
export default function SupporterAboutSection({ data, onEditAction }: SupporterAboutSectionProps) {
  return (
    <Card
      component="section"
      elevation={0}
      ...
      >
        <Stack spacing={{ xs: 2, sm: 2.5 }}>
          ...
          <Stack spacing={1.25}>
            ...
            <DetailRow label="Localização atual" value={data.currentLocation} />
