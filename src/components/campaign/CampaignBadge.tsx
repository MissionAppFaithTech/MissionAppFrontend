    ...
    <Chip
      icon={
        <VerifiedIcon
          sx={{
            ...
            color: (theme) =>
              theme.palette.mode === 'dark' || isHero
                ? '#FB923C !important'
      ...
      sx={{
        ...
        ...(isHero
          ? {
              background:
                'linear-gradient(135deg, rgba(249, 115, 22, 0.35) 0%, rgba(194, 65, 12, 0.55) 100%)',
              backdropFilter: 'blur(12px)',
              WebkitBackdropFilter: 'blur(12px)',
              border: '1.5px solid rgba(251, 146, 60, 0.75)',
              color: '#FFFFFF',
              boxShadow:
                '0 4px 16px rgba(234, 88, 12, 0.45), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
